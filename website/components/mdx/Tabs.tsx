 ...
 * <Tabs
 *   items={[
 *     { value: 'npm', label: 'npm', content: <pre>npm install rube-goldberg-tui</pre> },
 *     { value: 'bun', label: 'bun', content: <pre>bun add rube-goldberg-tui</pre> },
 *     { value: 'pnpm', label: 'pnpm', content: <pre>pnpm add rube-goldberg-tui</pre> },
 *   ]}
 * />
 */
