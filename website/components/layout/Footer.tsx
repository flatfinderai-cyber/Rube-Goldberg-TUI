...
const footerSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'GitHub',
        href: 'https://github.com/subsy/rube-goldberg-tui',
        external: true,
      },
      {
        label: 'Issues',
        href: 'https://github.com/subsy/rube-goldberg-tui/issues',
        external: true,
      },
      {
        label: 'Releases',
        href: 'https://github.com/subsy/rube-goldberg-tui/releases',
        external: true,
      },
    ],
  },
  {
    ...
    links: [
      {
        label: 'Discussions',
        href: 'https://github.com/subsy/rube-goldberg-tui/discussions',
        external: true,
      },
      {
        label: 'Contributing',
        href: 'https://github.com/subsy/rube-goldberg-tui/blob/main/CONTRIBUTING.md',
        external: true,
      },
    ],
  },
