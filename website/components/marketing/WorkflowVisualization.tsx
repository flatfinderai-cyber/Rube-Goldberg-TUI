/**
 * ABOUTME: WorkflowVisualization component showing the rube-goldberg-tui 4-step execution loop.
...
/**
 * WorkflowVisualization component displaying the 4-step rube-goldberg-tui execution loop.
 *
 * Features:
