...
/**
 * Globe icon for web search skill.
  */
...
/**
 * Folder icon for file system skill.
  */
...
/**
 * Terminal icon for code execution skill.
  */
...
export function Hero() {
      ...
      const skills = [
          { id: 'web', name: 'Web Search', Icon: GlobeIcon },
          { id: 'file', name: 'File System', Icon: FolderIcon },
          { id: 'code', name: 'Code Execution', Icon: TerminalIcon },
          { id: 'api', name: 'API Calls', Icon: PlugIcon },
            ];
                                                      ...
                                                      {/* Blueprint-style textarea */}
                                                                <div className="relative mb-6">
                                                                                <textarea
                                                                                                      ...
                                                                                                      className="w-full h-32 p-4 bg-amber-50/50 border-2 border-dashed border-amber-300 rounded-xl text-amber-900 placeholder-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none font-mono text-sm"
                                                                                                      style={{
                                                                    ...
                                                                    {/* Model Selector */}
                                                                                <div className="flex items-center gap-2">
                                                                                                  ...
                                                                                                  <select
                                                                                                                          ...
                                                                                                                          className="px-3 py-2 bg-amber-100 border-2 border-amber-400 rounded-lg text-amber-900 font-medium focus:outline-none focus:ring-2 focus:ring-amber-500"
                                                                                                                        >
                                                                                                      {models.map((model) => (
                                      ...
                                      <button
                                          ...
                                          {skill.name}
                                                      ...
                                                      {/* Build Loop Button - Brass Lever Style */}
                                                                <button
                                                                                    className="w-full py-4 bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 text-white font-bold text-lg rounded-xl transform transition-transform hover:translate-y-0.5 active:translate-y-1 active:shadow-none"
                                                                                    style={{
                                                  ...
                                                  <div className="relative w-full max-w-md">
                                                      ...
                                                      {/* Mascot Image */}
                                                                <div className="relative bg-gradient-to-br from-amber-100 to-amber-200 rounded-2xl p-8 shadow-2xl border-2 border-amber-300">
                                                                                <div className="aspect-square bg-amber-50 rounded-xl overflow-hidden border-2 border-amber-300">
                                                                                    {/* TODO: Replace with actual mascot image path */}
                                                                                                  <Image
                                                                                                                          src="/mascot.png"
                                                                                                                          alt="Rube the Cat - Master Orchestrator"
                                                                                                                          width={400}
                                                                                                                          height={400}
