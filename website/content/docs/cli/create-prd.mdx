...
```bash
rube-goldberg-tui create-prd [options]
```
...
```bash
rube-goldberg-tui prime    # Same as create-prd
```
...
rube-goldberg-tui create-prd --chat --agent opencode
```
...
rube-goldberg-tui create-prd --stories 8
```
...
rube-goldberg-tui create-prd --chat --output ./docs/prds

# Overwrite existing PRD
rube-goldberg-tui create-prd --chat --force
```
...
rube-goldberg-tui create-prd --chat --timeout 0

# Set custom timeout (in milliseconds)
rube-goldberg-tui create-prd --chat --timeout 600000  # 10 minutes
```
...
rube-goldberg-tui create-prd --chat --prd-skill my-custom-skill
```
...
Quality gates are critical for successful automation. They tell rube-goldberg what commands must pass after each task.
