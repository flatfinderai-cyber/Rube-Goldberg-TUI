...
description: Understanding rube-goldberg TUI's plugin system for agent and tracker integrations.
---

## Plugin Architecture

rube-goldberg TUI uses a plugin system to support multiple AI agents and task trackers. This modular design lets you choose the tools that best fit your workflow.
...
rube-goldberg TUI has two categories of plugins:
...
<TabsRoot defaultValue="getting-started">
  ...
  <TabsContent value="team">
    ...
    ```bash
    rube-goldberg-tui run --tracker beads --epic my-epic
    ```
  ...
  <TabsContent value="large">
    ...
    ```bash
    rube-goldberg-tui run --tracker beads-bv --epic my-epic
    ```
...
```bash
rube-goldberg-tui run --agent opencode --tracker beads-bv --epic my-epic
```
...
# Switch between them
# rube-goldberg-tui run --agent claude-fast
```
