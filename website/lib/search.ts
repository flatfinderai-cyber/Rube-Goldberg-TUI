...
function getSnippetForPage(title: string, href: string): string {
  const snippets: Record<string, string> = {
    ...
    '/docs/getting-started/quick-start': 'Get up and running with RubeGoldberg TUI in 5 minutes',
    '/docs/getting-started/installation': 'Install RubeGoldberg TUI via npm, bun, or from source',
    '/docs/cli/overview': 'Complete reference for all RubeGoldberg TUI CLI commands',
    ...
    '/docs/cli/setup': 'Initialize RubeGoldberg TUI configuration in your project',
    '/docs/cli/create-prd': 'Generate PRD templates for task definition',
    '/docs/cli/convert': 'Convert between task tracker formats',
    '/docs/configuration/overview': 'Customize RubeGoldberg TUI behavior and preferences',
    '/docs/configuration/config-file': 'rubeGoldberg.config.json structure and location',
    '/docs/configuration/options': 'Complete reference of all configuration options',
    '/docs/plugins/overview': 'Extend RubeGoldberg TUI with agent and tracker plugins',
...
function getSectionsForPage(href: string): Array<{ title: string; snippet: string }> {
  const sections: Record<string, Array<{ title: string; snippet: string }>> = {
    '/docs/getting-started/introduction': [
      ...
      { title: 'Why RubeGoldberg TUI', snippet: 'Eliminate the copy-paste-wait cycle for AI-assisted coding' },
    ],
    '/docs/cli/run': [
