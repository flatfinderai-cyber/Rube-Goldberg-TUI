/**
 * ABOUTME: Cross-platform sound playback utility for rube-goldberg-tui.
 * Provides audio playback across macOS, Linux, and Windows.
 * Supports system notification sounds and bundled Rube Goldberg clips.
 */
...
/**
 * List of bundled Rube Goldberg sound files.
...
/**
 * Play a random Rube Goldberg sound clip.
