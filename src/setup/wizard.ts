/**
 * ABOUTME: Interactive setup wizard for RubeGoldberg TUI.
 * Guides users through initial configuration when no .rube-goldberg-tui/config.toml exists.
 ...
 */
const CONFIG_DIR = '.rube-goldberg-tui';
...
/**
 * Save configuration to .rube-goldberg-tui/config.toml
 */
async function saveConfig(
  ...
  // Ensure .rube-goldberg-tui directory exists
  ...
  // Add header comment
  const content = `# RubeGoldberg TUI Configuration
# Generated by setup wizard
# See: rube-goldberg-tui config help
...
export async function runSetupWizard(
  ...
  try {
    ...
    console.log();
    console.log('╔════════════════════════════════════════════════════════════╗');
    console.log('║                   RubeGoldberg TUI Setup Wizard                    ║');
    console.log('╚════════════════════════════════════════════════════════════╝');
    console.log();
    printInfo('This wizard will help you configure RubeGoldberg TUI for your project.');
    ...
    const selectedTracker = await promptSelect(
      ...
      trackerChoices,
      {
        ...
        help: 'RubeGoldberg will use this tracker to manage tasks.',
      }
    );
    ...
    printInfo('RubeGoldberg supports multiple AI coding agents.');
    if (defaultAgent) {
    ...
    if (bundledSkills.length > 0) {
      printInfo('RubeGoldberg TUI includes AI skills that enhance agent capabilities.');
    ...
    console.log();
    printInfo('You can now run RubeGoldberg TUI with:');
    console.log();
    console.log('  rube-goldberg-tui run');
    console.log();
    printInfo('Or edit the configuration with:');
    console.log();
    console.log('  rube-goldberg-tui config show');
    console.log();
...
export async function checkAndRunSetup(
  ...
  if (options.skipSetup) {
    ...
    printInfo('No configuration found. Run "rube-goldberg-tui setup" to create one.');
    return null;
  }
