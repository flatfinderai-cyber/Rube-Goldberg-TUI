/**
 * ABOUTME: Skill installation utility for rube-goldberg-tui.
 * Provides functions to install skills to the user's ~/.claude/skills/ directory.
 * Skills are bundled with rube-goldberg-tui and can be installed during setup.
 */
...
export interface SkillInfo {
  ...
  /** Path to the skill in the rube-goldberg-tui package */
  sourcePath: string;
}
...
/**
 * Get the path to the bundled skills in the rube-goldberg-tui package.
 */
...
/**
 * Install the rube-goldberg-tui-prd skill specifically.
 */
export async function installRalphTuiPrdSkill(
  ...
  return installSkill('rube-goldberg-tui-prd', options);
}
