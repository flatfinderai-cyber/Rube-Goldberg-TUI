...
/**
 * Get the user config directory path for rube-goldberg-tui.
 * @returns Path to ~/.config/rube-goldberg-tui/
 */
export function getUserConfigDir(): string {
  return path.join(homedir(), '.config', 'rube-goldberg-tui');
}
 ...
 * 2. ~/.config/rube-goldberg-tui/{mode-specific}.md (user config directory)
 ...
 * Creates ~/.config/rube-goldberg-tui/ and copies prompt.md and prompt-beads.md.
