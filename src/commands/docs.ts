/**
 * ABOUTME: Docs command for rube-goldberg-tui.
...
const DEFAULT_REPO_URL = 'https://github.com/subsy/rube-goldberg-tui';
...
Usage: rube-goldberg-tui docs [section] [options]
...
Examples:
  rube-goldberg-tui docs              # Open main documentation
  rube-goldberg-tui docs quickstart   # Open quick start guide
  rube-goldberg-tui docs --url        # Print main docs URL
  rube-goldberg-tui docs cli --url    # Print CLI reference URL
`);
}
