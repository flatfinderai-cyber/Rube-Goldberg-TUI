...
Description:
  ...
  The configuration is saved to .rube-goldberg-tui/config.toml in your project root.

Examples:
  rube-goldberg-tui setup              # Run interactive setup
  rube-goldberg-tui setup --force      # Overwrite existing config
`);
}
