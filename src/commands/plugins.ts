...
export function printPluginsHelp(): void {
  console.log(`
rube-goldberg-tui plugins - Manage and inspect plugins

Usage: rube-goldberg-tui plugins <subcommand>
...
Description:
  ...
  Custom plugins can be added to:
    ~/.config/rube-goldberg-tui/plugins/agents/
    ~/.config/rube-goldberg-tui/plugins/trackers/
 ...
 * Called via: rube-goldberg-tui plugins trackers
 */
 ...
 * Called via: rube-goldberg-tui plugins agents
 */
