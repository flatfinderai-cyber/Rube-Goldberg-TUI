 ...
 * Controls how rube-goldberg-tui responds when an agent hits API rate limits.
 */
...
export const DEFAULT_CONFIG: Omit<RalphConfig, 'agent' | 'tracker'> = {
  ...
  iterationDelay: 1000,
  cwd: process.cwd(),
  outputDir: '.rube-goldberg-tui/iterations',
  progressFile: '.rube-goldberg-tui/progress.md',
  showTui: true,
