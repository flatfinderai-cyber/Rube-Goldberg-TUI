  ...
  return [
    {
      key: '1',
      name: 'JSON (prd.json)',
      skillPrompt: `Convert this PRD to prd.json format using the rube-goldberg-tui-create-json skill.
...
The output file MUST be saved to: tasks/prd.json`,
    ...
    },
    {
      key: '2',
      name: 'Beads issues',
      skillPrompt: 'Convert this PRD to beads using the rube-goldberg-tui-create-beads skill.',
      available: hasBeads,
    },
  ];
}
