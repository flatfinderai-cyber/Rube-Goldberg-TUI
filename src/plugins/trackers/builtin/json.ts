...
To fix: Regenerate the tasks using "rube-goldberg-tui convert --to json <prd-file.md>"
or manually restructure the file to match the schema above.`
  ...
  if (errors.length > 0) {
    throw new PrdJsonSchemaError(
      ...
      errors,
      'Run "rube-goldberg-tui convert --to json <prd-file.md>" to regenerate with correct schema, ' +
