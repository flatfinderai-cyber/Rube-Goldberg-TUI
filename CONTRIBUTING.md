# Contributing to Rube Goldberg TUI

Thank you for your interest in contributing to Rube Goldberg TUI! This document provides guidelines and information for contributors.
...
Currently, Rube Goldberg TUI relies on manual testing:
...
1. **Rube Goldberg TUI version** (`rube-goldberg-tui --version` or check package.json)
2. **Bun version** (`bun --version`)
3. **Operating system**
4. **Steps to reproduce**
5. **Expected behavior**
6. **Actual behavior**
7. **Relevant logs** (from `.rube-goldberg-tui/iterations/`)
...
Thank you for contributing to Rube Goldberg TUI!
